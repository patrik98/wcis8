...
function changeText(text, description) {
    document.getElementById("sectionTitle").innerText = text;
    document.getElementById("sectionDescription").innerText = description;
    document.getElementById("informationBox").classList.add("fade-off");
    setTimeout(function() {
        document.getElementById("informationBox").classList.add("fade-on");
        }, 400);
    document.getElementById("informationBox").classList.remove("fade-on");
